                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <canvas id="chart01"></canvas>
                                ...
                                $query01 = "SELECT DISTINCT ProductName as ProductName, UnitPrice
                                            FROM Products AS price1
                                            WHERE 5 >= (SELECT COUNT(DISTINCT UnitPrice)
                                            FROM Products AS price2
                                            WHERE price2.UnitPrice >= price1.UnitPrice)
                                    ...
                                    const UnitPrice = <?php echo json_encode($UnitPrice); ?>;
                                        ...
                                        const data1 ={
                                            labels: label_barchart,
                                                datasets: [{
                                                    label: 'Top Expensives',
                                                    data: UnitPrice,
                                                    backgroundColor: ['rgb(139, 14, 236)'],
                                                    hoverOffset: 4
                                            }]
                                        };
                                    // <!-- config block -->
                                        ...
                                        // <!-- render block -->
                                        const chart01 = new Chart(document.getElementById('chart01'),config1);
                                </script>
